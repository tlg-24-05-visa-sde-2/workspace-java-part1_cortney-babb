...
public class HourlyEmployee extends Employee {
    ...
    // TODO implement setter validation
    public void setRate(double rate) throws IllegalArgumentException {
        if (rate < FEDERAL_MINIMUM_WAGE) {
            throw new IllegalArgumentException("Error: Illegal wage: " + rate +
                    ". Federal minimum rate must be at least " +
                    FEDERAL_MINIMUM_WAGE + " or greater.");
        }
        this.rate = rate;
    }
